...
{
    internal class ShankarExtParameters
    {
        ...
        public ShankarExtParameters(InsensitiveDictionary<JToken> connectionParameters, ServiceOperationRequest serviceOperationRequest)
        {
